...
<h1> Welcome to Income tax preparation website </h1>
 ...
 <nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<div class="btn">
		<a href="create.php"><button type="button" class="w3-button w3-black w3-border w3-hover-pale-red w3-round-xxlarge">enter salary details</button></a>
		<br></br>
		
		<a href="displaysal.php"><button type="button" class="w3-button w3-black w3-border w3-hover-teal w3-round-xxlarge">Display salary details</button></a>
	<div>
</body>
</html>